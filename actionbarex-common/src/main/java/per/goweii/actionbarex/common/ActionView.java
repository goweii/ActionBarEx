...
public final class ActionView extends FrameLayout {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        final int textColorDef = ContextCompat.getColor(getContext(), R.color.text_color_def);
        ...
        final int iconColorDef = ContextCompat.getColor(getContext(), R.color.icon_color_def);
