...
public final class ActionBarSuper extends ActionBarEx {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        int leftTextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int left1TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int left2TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int left3TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int left4TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int left5TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int rightTextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int right1TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int right2TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int right3TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int right4TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
        ...
        int right5TextMarginTemp = (int) typedArray.getDimension(R.styleable.ActionView_av_textMargin, -1);
    ...
    protected View inflateTitleBar() {
        titleBarChild = (RelativeLayout) inflate(getContext(), R.layout.action_bar_title_bar_suoer, null);
        initTitleTextView();
        initLeftActionViews();
